...
import (
	...
	"github.com/shortintern2020-C-cryptograph/TeamF/gen/restapi/scenepicks"
)
...
func configureAPI(api *scenepicks.SecenPickServerAPI) http.Handler {
	...
	if api.GetDialogIDCommentHandler == nil {
		api.GetDialogIDCommentHandler = scenepicks.GetDialogIDCommentHandlerFunc(func(params scenepicks.GetDialogIDCommentParams) middleware.Responder {
			return middleware.NotImplemented("operation scenepicks.GetDialogIDComment has not yet been implemented")
		})
	}
	if api.PostDialogIDCommentHandler == nil {
		api.PostDialogIDCommentHandler = scenepicks.PostDialogIDCommentHandlerFunc(func(params scenepicks.PostDialogIDCommentParams) middleware.Responder {
			return middleware.NotImplemented("operation scenepicks.PostDialogIDComment has not yet been implemented")
		})
	}
