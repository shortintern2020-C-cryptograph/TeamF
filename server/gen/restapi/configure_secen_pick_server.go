...
import (
	...
	mymiddleware "github.com/shortintern2020-C-cryptograph/TeamF/server/middleware"
	"net/http"
...
func configureAPI(api *scenepicks.SecenPickServerAPI) http.Handler {
	...
	api.PostToTwitterHandler = scenepicks.PostToTwitterHandlerFunc(handler.PostToTwitter)
