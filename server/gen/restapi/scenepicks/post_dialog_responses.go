...
type PostDialogOK struct {
	...
	/*
	  In: Body
	*/
	Payload *PostDialogOKBody `json:"body,omitempty"`
}
...
func (o *PostDialogOK) WithPayload(payload *PostDialogOKBody) *PostDialogOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post dialog o k response
func (o *PostDialogOK) SetPayload(payload *PostDialogOKBody) {
	o.Payload = payload
}
